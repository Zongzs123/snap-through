...
def train(args):
    ...
    for train_index, val_index in kfold.split(inputs):
        ...
        train_result = inverse_model.fit(train_inputs, train_targets, epochs=args.epochs, batch_size=args.batch_size,
...
if __name__ == '__main__':
    ...
    for i in range(5):
        ...
        args.run_name = "./inverse_network_batch_size" + str(args.batch_size) + "/"
        train(args)
